...
class DashboardController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->start = Carbon::today()->subDays(30);
    ...
    public function index()
    {
        ...
        $statistics = [
            ...
            //'browsers' => Analytics::getTopBrowsers($this->period, $this->limit),
            //'pages' => Analytics::getMostVisitedPages($this->period, $this->limit),
    ...
    {
        return Analytics::performQuery(Period::days(7),$metrics,$options)->rows;
    }
